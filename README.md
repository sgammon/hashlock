...
> [!NOTE]
> The CLI does not support Windows yet. Once [Bun](https://github.com/oven-sh/bun/issues/43) ships support for standalone Windows executables, this project will follow suit.
